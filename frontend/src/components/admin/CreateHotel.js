      ...
      <div className="">
        <div className="space-y-12">
          ...
          {hotel != null && amenities != null ?
            <form onSubmit={e => handleSubmitAmenities(e)} className="border-b border-gray-900/10 pb-12">

              <div className="mt-10 space-y-10">
                <fieldset>
                  <legend className="text-sm font-semibold leading-6 text-gray-900">Amenities</legend>
                  <div className="mt-6 space-y-6">
                    {amenities !== null && amenities.map(amenity => (
                      <div className="relative flex gap-x-3">
                        <div className="flex h-6 items-center">
                          <input
                            id={amenity.title}
                            name={amenity.title}
                            onChange={(e) => handleAmenityChange(e, amenity.amenitie_id)}
                            checked={selectedAmenities.includes(amenity.amenitie_id)}
                            type="checkbox"
                            className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600"
                          />
                        </div>
                        <div className="text-sm leading-6">
                          <label htmlFor={amenity.title} className="font-medium text-gray-900">
